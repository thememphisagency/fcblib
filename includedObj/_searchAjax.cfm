...
<cfif isdefined("url.criteria") AND NOT isDefined('form.quickSearchSubmit')>
...
<div class="search">
	<fieldset class="option-bar">
		<form name="quickSearch" id="quickSearch" method="post" action="#sLink#">			
			...
			<button class="search" id="quickSearchSubmit" name="quickSearchSubmit"><i class="icon-search"></i></button>												
		</form>
	</fieldset>
