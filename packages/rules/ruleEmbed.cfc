...
--->
<cfcomponent displayname="Embed: Generic" extends="farcry.core.packages.rules.rules" 
	hint="Insert Code">
	...
	<cfproperty ftSeq="2" ftFieldSet="Rule Options" name="embedCode" type="longchar" hint="The code" ftLabel="Embed Code" />
</cfcomponent>