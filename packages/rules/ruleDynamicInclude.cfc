<cfcomponent name="ruleDynamicInclude" displayname="Dynamic Include" extends="farcry.core.packages.rules.rules">
	...
	<cfproperty ftSeq="1" ftFieldset="Rule Details" ftLabel="Heading" bLabel="1" name="label" hint="label" type="string" ftType="string" required="false" default="" />
	<cfproperty ftSeq="2" ftFieldset="Rule Details" ftLabel="Introduction" name="intro" hint="Intro text" type="string" ftType="string" required="false" default="" />
	...
	<cfproperty ftSeq="4" ftFieldset="Rule Details" ftLabel="Dynamic Variables" name="dynamicVariables" hint="" type="string" ftType="string" required="false" default="" />
