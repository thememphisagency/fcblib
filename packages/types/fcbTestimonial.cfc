...
<cfcomponent extends="farcry.plugins.fcblib.packages.types.fcbVersions" displayname="Testimonial" hint="A little snippet of testimonial information including a label, testimonial text, name and postion" bObjectBroker="true" bPaginatorAnimateByTypeRule="1">
