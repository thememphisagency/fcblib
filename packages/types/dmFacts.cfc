...
<cfcomponent extends="farcry.plugins.farcrycms.packages.types.dmFacts" displayname="Fact" hint="Facts are little snippets of information; factoids, quotes, testimonials, brand messages and more. Create a library of facts and have them publish randomly on your site tokeep things interesting." bSchedule="true" bObjectBroker="true" bPaginatorAnimateByTypeRule="1">

	<cfproperty ftseq="1" ftfieldset="Fact Details" bCleanHTML="1" name="title" type="string" hint="Meaningful reference title" required="no" default="" ftLabel="Title" ftvalidation="required" />
	<cfproperty ftseq="4" ftfieldset="Fact Details" bCleanHTML="1" name="body" type="longchar" hint="Content of the factoid." required="No" default="" ftLabel="Content" ftType="longchar" />

	<cfproperty ftSeq="11" ftfieldset="Sensitive Data?" ftLabel="Sensitive" name="bSensitive" type="boolean" hint="" required="no" default="0" ftRenderType="checkbox" />
