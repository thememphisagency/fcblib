...
<cfcomponent extends="farcry.plugins.farcrycms.packages.types.dmEvent" displayname="Events" hint="Calendar events happen at a given place and time. Events can be published in list and month calendar formats." bSchedule="true" bFriendly="true" bObjectBroker="true" bRotator="1" bPaginatorSearchByCategory="1" bPaginatorAnimateByTypeRule="1">
  ...
  <cfproperty ftseq="31" ftfieldset="Event Description" ftwizardStep="Event Details" name="body" type="longchar" hint="Main body of content." required="no" default="" ftType="RichText" ftlabel="Body Content" ftTemplateTypeList="dmImage,dmFile,fcbExternalVideo" />
	...
	<cfproperty ftseq="51" ftfieldset="Related Content" ftwizardStep="Event Details" name="aObjectIDs" type="array" ftType="array" hint="Mixed type children objects that sit underneath this object" required="no" default="" ftJoin="dmImage,dmFile,fcbExternalVideo" ftlabel="Media Library" bSyncStatus="true" />
