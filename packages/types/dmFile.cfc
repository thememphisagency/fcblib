<cfcomponent extends="farcry.core.packages.types.dmfile" displayname="File" bPaginatorAnimateByTypeRule="1" bPaginatorSearchByCategory="1">
	<cfproperty ftSeq="1" ftFieldset="File Details" bCleanHTML="1" name="title" type="string" hint="Meaningful reference title for file" required="no" default="" ftLabel="Title" blabel="true" />
	<cfproperty ftSeq="2" ftFieldset="File Details" bCleanHTML="1" name="description" type="string" hint="A description of the file to be uploaded." required="No" default="" fttype="longchar" ftLabel="Description" />

	<!--- extending the standard dmfile to render the upload field as html and not flash --->	
	<cfproperty ftSeq="3" ftFieldset="File Details" name="filename" type="string" hint="The name of the file to be uploaded" required="no" default="" ftRenderType="html" ftType="file" ftLabel="File" ftDestination="/dmfile" ftSecure="false"
				ftAllowedFileExtensions="pdf,doc,ppt,xls,docx,pptx,xlsx,jpg,jpeg,png,gif,zip,rar,flv,swf,mpg,mpe,mpeg,m1s,mpa,mp2,m2a,mp2v,m2v,m2s,mov,qt,asf,asx,wmv,wma,wmx,rm,ra,ram,rmvb,mp3,mp4,3gp,ogm,mkv,avi,ogv" />
