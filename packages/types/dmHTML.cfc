<cfcomponent extends="farcry.core.packages.types.dmHTML" displayname="HTML" bUseInTree="1" bSchedule="true" bFriendly="true" bObjectBroker="true" bRotator="1" bPaginatorSearchByCategory="1" bPaginatorAnimateByTypeRule="1">
	...
	<cfproperty ftSeq="6" ftwizardStep="Teaser" ftFieldset="Teaser" name="readMoreText" ftlabel="Read More Text" type="nstring" ftType="string" hint="Display text for read more link for object teasers" required="no" default="Read more">

   <!--- Removed the restriction where the teaser image must be selected first in the related media --->
    <cfproperty ftSeq="11" ftwizardStep="Teaser" ftFieldset="Teaser" name="teaserImage" type="uuid" ftType="uuid" hint="UUID of image to display in teaser" required="no" default=""
	   ftLabel="Teaser Image" ftJoin="dmImage" ftLibraryData="" ftLibraryDataTypename="" />
