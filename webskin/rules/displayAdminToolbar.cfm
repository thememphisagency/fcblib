	...
	<div class="ruleadmin">
		...
		<div style="float:right;">
			...
			<a title="Configure rule" 
				...
				href="#application.url.farcry#/conjuror/invocation.cfm?objectid=#stObj.objectid#&refobjectid=#request.navid#&typename=#stObj.typename#&method=editInPlace&originalID=#stParam.originalID#&iframe" 
